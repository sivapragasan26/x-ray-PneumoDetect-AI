"""
Model Training Script for Chest X-Ray Pneumonia Detection
Trains MobileNetV2 model on balanced chest X-ray dataset
"""
...
class ChestXRayTrainer:
    """
    Professional trainer class for chest X-ray pneumonia detection model
    """
    ...
    def evaluate_model(self, test_gen):
        ...
        # Load best model
        self.model.load_weights('../../models/best_chest_xray_model.h5')
        ...
        if normal_accuracy > 0 and pneumonia_accuracy > 0:
            ...
            if bias_ratio < 1.15:
                ...
                print("Some class bias detected")
...
def main():
    ...
    # Save final model
    trainer.model.save('../../models/final_chest_xray_model.h5')
    ...
    print(f"Bias eliminated through balanced dataset")
