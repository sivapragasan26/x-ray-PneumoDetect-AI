...
st.markdown(
    ...
    /* Full-screen gradient background with animation - USER REQUESTED GRADIENT */
    .stApp {
    ...
    /* Header with floating animation and emojis */
    .hero {
        text-align: center;
        margin-bottom: 40px;
    }
    ...
    /* Social icons styling - CUSTOM SVG ICONS */
    .social-section {
        text-align: center;
    ...
    /* Footer styling - kept simple as requested */
    .footer {
        text-align: center;
        margin-top: 60px;
        padding: 30px;
...
# Social media icons section with YOUR CUSTOM SVG ICONS
st.markdown(
    """
...
# Disclaimer in box - content unchanged as requested
st.markdown(
    """
...
# Footer - kept simple as requested, removed "Developed by" text
st.markdown(
    f"""
    <div class="footer">
